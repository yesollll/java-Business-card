...
<body>
	...
	<tr>
		<td bgcolor="#dcdcdc" height="21" align="center">답변달기</td>
	</tr>
	</table><br>
	
	<form name="BoardReplyForm" method="post" action="Board_Reply_action.jsp" onsubmit="return boardReplyCheck();">
		...
		<tr>
			...
			<table border="0" width="100%" align="center">
				...
				<tr>
					...
					<td width="50%"><textarea name="content" rows="10" cols="70">가나다라마바사</textarea></td>
				</tr>
				<tr>
